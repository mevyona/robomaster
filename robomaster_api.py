...
class RoboMaster:
    ...
    def fire(self, fire_type="laser"):
        """
        Triggers robot fire:
        - "laser" (default): Infrared simulation laser (sound + LED flash, no beads)
        - "bead": Real physical gel bead shot (flywheels + mechanical feed)
        """
